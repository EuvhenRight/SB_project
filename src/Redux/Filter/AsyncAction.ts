...
export const universalPostData = createAsyncThunk<PaginationInfo, filterValues>(
  ...
  async (params) => {
    ...
    const apiUrl = `https://frontend-case-api.sbdev.nl/api/posts?page=${page}&perPage=${perPage}&sortBy=${sortBy}&sortDirection=${sortDirection}&searchPhrase=test ber&categoryId=${categoryId}`;
